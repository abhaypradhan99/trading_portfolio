...
const PortfolioTotal = ({ total, allocations, lastUpdated }: PortfolioTotalProps) => {
  return (
<div className="bg-card p-6 rounded-lg flex flex-col md:flex-row justify-between items-center shadow-lg">
  <div>
    <h2 className="text-gray-400 uppercase text-xs">Portfolio Total</h2>
    <p className="text-4xl font-bold text-white mt-2">${total.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
  ...
  <div className="mt-4 md:mt-0">
    <h2 className="text-gray-400 uppercase text-xs mb-2">Allocations</h2>
